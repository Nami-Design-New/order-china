  ...
  var axilInit = {
    ...
    axilSlickActivation: function (e) {
      $(".categrie-product-activation").slick({
        ...
        rtl: true,
        prevArrow:
          '<button class="slide-arrow prev-arrow"><i class="fal fa-long-arrow-right"></i></button>',
        nextArrow:
          '<button class="slide-arrow next-arrow"><i class="fal fa-long-arrow-left"></i></button>',
        responsive: [
          {
            breakpoint: 1199,
            settings: {
    ...
    countdownInit: function (countdownSelector, countdownTime) {
      ...
      if (eventCounter.length) {
        eventCounter.countdown(countdownTime, function (e) {
          $(this).html(
            e.strftime(
              "<div class='countdown-section'><div><div class='countdown-number'>%-D</div> <div class='countdown-unit'> يوم </div> </div></div><div class='countdown-section'><div><div class='countdown-number'>%H</div> <div class='countdown-unit'> ساعة </div> </div></div><div class='countdown-section'><div><div class='countdown-number'>%M</div> <div class='countdown-unit'> دقيقة </div> </div></div><div class='countdown-section'><div><div class='countdown-number'>%S</div> <div class='countdown-unit'> ثانية </div> </div></div>"
            )
          );
        });
      }
